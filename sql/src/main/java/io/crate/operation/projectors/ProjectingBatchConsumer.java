 ...
 * </pre>
 */
public class ProjectingBatchConsumer implements BatchConsumer<Row> {

    private final BatchConsumer<Row> consumer;
    private final List<Projector> projectors;
    private boolean requiresScroll;

    public static BatchConsumer<Row> create(BatchConsumer<Row> lastConsumer,
    ...
    private ProjectingBatchConsumer(BatchConsumer<Row> consumer,
                                    Collection<? extends Projection> projections,
                                    UUID jobId,
                                    RamAccountingContext ramAccountingContext,
                                    ProjectorFactory projectorFactory) {
